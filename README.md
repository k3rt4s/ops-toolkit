...
| `scripts\windows-hardening\Set-Windows11PrivacyHardening.ps1`             | Renamed and rebuilt Windows 11 privacy hardening with `-WhatIf`, plan reports, registry backups, and summaries. |
