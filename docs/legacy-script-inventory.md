...
| `scripts\printers\Add-LegacyPrinterConnections.vbs`                   | Added a hard-coded set of Windows network printer connections.                           | `scripts\printers\Add-WindowsPrinterConnections.ps1`                |
| `scripts\printers\Remove-LegacyPrinterConnection.vbs`                 | Enumerated and removed Windows network printer connections.                              | `scripts\printers\Remove-WindowsPrinterConnections.ps1`             |
| `scripts\utilities\Convert-IpAddressToDecimalAndBinary.vbs`           | Converted an IPv4 address to binary and decimal formats, with an optional ping check.    | `scripts\utilities\Convert-IpAddressToDecimalAndBinary.ps1`         |
| `scripts\utilities\Set-WindowsVolumeProductKey.vbs`                   | Installed a Windows volume product key through WMI.                                      | `scripts\utilities\Set-WindowsVolumeProductKey.ps1`                 |
...
| `scripts\utilities\Start-BgInfoForLegacyWindows.cmd`                  | Started BGInfo from legacy local or network paths.                                       | `scripts\utilities\Start-BgInfo.ps1`                                |
