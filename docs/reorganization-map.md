...
- `scripts\windows-hardening\Set-Windows11PrivacyHardening.ps1` replaces the older one-way telemetry and consumer-feature script with a Windows 11 scoped report-first workflow, rollback, state reports, registry backups, and summary output.
