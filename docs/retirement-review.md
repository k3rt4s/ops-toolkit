...
| ---------------------------------------------------- | ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `archive\windows-hardening\Bloat-Remove-Replace.ps1` | Retired historical script | Superseded by `scripts\it-operations\windows-hardening\Remove-WindowsProvisionedBloatwareApps.ps1` and retained only for comparison.                                 |
| `archive\windows-hardening\Bloat-Server-Removal.ps1` | Retired historical script | Superseded by `scripts\it-operations\windows-hardening\Remove-WindowsProvisionedBloatwareApps.ps1` and retained only for comparison.                                 |
...
| Windows hardening | `scripts\it-operations\windows-hardening\` | Kept, except Cortana-specific scripts. High-impact scripts should be run first with `-WhatIf` when supported.                   |
| Utilities         | `scripts\it-operations\utilities\`         | Kept; CSV comparison script was fixed and parameterized.                                                                        |
