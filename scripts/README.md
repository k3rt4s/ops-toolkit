...
- `web/` - External HTTP/HTTPS exposure and security-header checks (HSTS, clickjacking protection, and a fleet-wide posture sweep with remediation and risk-argument context) against a caller-supplied host list.
