<#
.SYNOPSIS
Install an Azure VPN Client rasphone.pbk profile for the current user.

.INSTRUCTIONS
- Read the root README.md before running this script.
- Review parameters with Get-Help .\Install-AzureVpnClientProfileFromPbk.ps1 -Full or by opening the script.
