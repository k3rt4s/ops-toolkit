<#
.SYNOPSIS
Disable legacy SCHANNEL protocols and weak cipher suites.

.INSTRUCTIONS
- Read the root README.md before running this script.
- Review parameters with Get-Help .\Disable-LegacySchannelProtocolsAndCiphers.ps1 -Full or by opening the script.
...
Write-Information 'Configuring IIS with SSL/TLS Deployment Best Practices...' -InformationAction Continue
...
Write-Information 'Multi-Protocol Unified Hello has been disabled.' -InformationAction Continue
...
Write-Information 'PCT 1.0 has been disabled.' -InformationAction Continue
...
Write-Information 'SSL 2.0 has been disabled.' -InformationAction Continue
...
Write-Information 'SSL 3.0 has been disabled.' -InformationAction Continue
...
Write-Information 'TLS 1.0 has been disabled.' -InformationAction Continue
...
Write-Information 'TLS 1.1 has been disabled.' -InformationAction Continue
...
Write-Information 'TLS 1.2 has been enabled.' -InformationAction Continue
...
Foreach ($insecureCipher in $insecureCiphers) {
    ...
    $key.close()
    Write-Information "Weak cipher $insecureCipher has been disabled." -InformationAction Continue
}
...
Foreach ($secureCipher in $secureCiphers) {
    ...
    $key.close()
    Write-Information "Strong cipher $secureCipher has been enabled." -InformationAction Continue
}
...
Foreach ($secureHash in $secureHashes) {
    ...
    $key.close()
    Write-Information "Hash $secureHash has been enabled." -InformationAction Continue
}
...
Foreach ($secureKeyExchangeAlgorithm in $secureKeyExchangeAlgorithms) {
    ...
    $key.close()
    Write-Information "KeyExchangeAlgorithm $secureKeyExchangeAlgorithm has been enabled." -InformationAction Continue
}
...
Write-Information 'Configure longer DHE key shares for TLS servers.' -InformationAction Continue
...
if ([System.Version]$os.Version -lt [System.Version]'10.0') {
    Write-Information 'Use cipher suites order for Windows 2008/2008R2/2012/2012R2.' -InformationAction Continue
    $cipherSuitesOrder = @(
    ...
    Write-Information 'Use cipher suites order for Windows 10/2016 and later.' -InformationAction Continue
    $cipherSuitesOrder = @(
...
Write-Information 'Enable TLS 1.2 for .NET 3.5 and .NET 4.x' -InformationAction Continue
...
if ([System.Version]$file_version_winhttp_dll -lt [System.Version]"6.1.7601.23375" -or [System.Version]$file_version_webio_dll -lt [System.Version]"6.1.7601.23375") {
    Write-Information 'WinHTTP: Cannot enable TLS 1.2. Please see https://support.microsoft.com/en-us/help/3140245/update-to-enable-tls-1-1-and-tls-1-2-as-a-default-secure-protocols-in for system requirements.' -InformationAction Continue
} else {
    Write-Information 'WinHTTP: Minimum system requirements are met.' -InformationAction Continue
    Write-Information 'WinHTTP: Activate TLS 1.2 only.' -InformationAction Continue
...
Write-Information 'Windows Internet Explorer: Activate TLS 1.2 only.' -InformationAction Continue
...
Write-Information '--------------------------------------------------------------------------------' -InformationAction Continue
Write-Information 'NOTE: After the system has been rebooted you can verify your server' -InformationAction Continue
Write-Information '      configuration at https://www.ssllabs.com/ssltest/' -InformationAction Continue
